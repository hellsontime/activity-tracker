<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <!-- Login form -->
    <form @submit.prevent="login" class="p-8 flex flex-col rounded-md shadow-lg bg-light-grey">
      <h1 class="text-3xl text-at-light-greend mb-4">Login</h1>
      ...
      <router-link class="text-sm mt-6 text-center" :to="{name: 'Register'}">
        Do not have an account? <span class="text-at-light-green">Register</span>
      </router-link>
    </form>
  </div>
